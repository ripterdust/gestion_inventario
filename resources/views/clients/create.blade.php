...
<div class="box">
    ...
    <form action="{{ route('clients.store') }}" method="post" class="form">
        ...
        <div class="form-control">
            <input type="text" name="nit" id="nit" autocomplete="off" placeholder=" " class="form-control-input" required />
            <label for="nit" class="form-control-label">Nit</label>
        </div>

        <div class="form-control">
            <input type="text" class="form-control-input" autocomplete="off" placeholder=" " name="name" required />
            <label for="name" class="form-control-label">Nombre completo</label>
        </div>

        <div class="form-control">
            <input type="date" name="birth" autocomplete="off" placeholder=" " class="form-control-input" required />
            <label for="date" class="form-control-label">Fecha de nacimiento</label>
        </div>

        <div class="form-control">
            <input type="email" class="form-control-input" autocomplete="off" placeholder=" " name="mail" required />
        ...
        <div class="form-control">
            <input type="text" class="form-control-input" autocomplete="off" placeholder=" " name="adress" required />
            <label for="adress" class="form-control-label">Dirección</label>
        </div>

        <div class="form-control">
            <input type="text" class="form-control-input" autocomplete="off" placeholder=" " name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required />
